...
export default function ReviewCard({ review }) {
  ...
  return (
    <View
      ...
      className="border p-4 m-2 rounded-lg border-slate-300"
    >
      <Text className="flex-1 text-md" style={{ lineHeight: 20, fontFamily: "gros-regular" }}>
        {review.comment}.
      </Text>

      <View className="flex-row mt-3 lex-1 items-center">
        <Image
        ...
        <View className="p-2 justify-between flex-col flex-1">
         ...
         <Text className="text-xs text-slate-600" style={{fontFamily: "gros"}}>{timeAgoDate}</Text> 
        </View>
      </View>
    </View>
  );
